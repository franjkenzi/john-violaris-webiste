...
export function SiteHeader() {
  ...
  return (
    <header className="site-header sticky top-0 z-50 bg-navy">
      ...
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between gap-4 px-5 sm:px-8 xl:h-[86px] xl:px-12">
        ...
        <nav aria-label="Main" className="hidden items-center gap-1 xl:flex">
          {mainNav.map((item) => (
            <Link
              ...
              className={`rounded-sharp px-3 py-2 text-[12.5px] font-medium transition-colors ${
                isActive(item.href)
                  ? "text-gold-light"
          ...
          <Link
            ...
            className="ml-3 rounded-sharp border border-gold/60 px-4 py-2.5 text-[11px] font-semibold tracking-[0.02em] text-gold-light transition-colors hover:bg-gold hover:text-navy"
          >
            Free Consultation
          </Link>
        </nav>
